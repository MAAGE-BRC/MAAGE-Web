...
(function (root, factory) {
  ...
  // Primary (Light)
  echarts.registerTheme("maage-mono-primary", {
    ...lightThemeBase,
    color: [
      "#324d41",
      "#3c5d4e",
  ...
  // Primary (Dark)
  echarts.registerTheme("maage-mono-primary-dark", {
    ...darkThemeBase,
    color: [
      "#d6e5de",
      "#b4d0c3",
  ...
  // Secondary (Light)
  echarts.registerTheme("maage-mono-secondary", {
    ...lightThemeBase,
    color: [
      "#2e4a56",
      "#365663",
  ...
  // Secondary (Dark)
  echarts.registerTheme("maage-mono-secondary-dark", {
    ...darkThemeBase,
    color: [
      "#c1d8e1",
      "#a0c1cf",
  ...
  // Tertiary (Light)
  echarts.registerTheme("maage-mono-tertiary", {
    ...lightThemeBase,
    color: [
      "#946729",
      "#bb8335",
  ...
  // Tertiary (Dark)
  echarts.registerTheme("maage-mono-tertiary-dark", {
    ...darkThemeBase,
    color: [
      "#f8edd8",
      "#f4e4c2",
  ...
  // Quaternary (Light)
  echarts.registerTheme("maage-mono-quaternary", {
    ...lightThemeBase,
    color: [
      "#48435b",
      "#585171",
  ...
  // Quaternary (Dark)
  echarts.registerTheme("maage-mono-quaternary-dark", {
    ...darkThemeBase,
    color: [
      "#dfdfec",
      "#cbc9de",
  ...
  // Quinary (Light)
  echarts.registerTheme("maage-mono-quinary", {
    ...lightThemeBase,
    color: [
      "#6c323a",
      "#7b363d",
  ...
  // Quinary (Dark)
  echarts.registerTheme("maage-mono-quinary-dark", {
    ...darkThemeBase,
    color: [
      "#f1dbda",
      "#e6bebb",
  ...
  echarts.registerTheme("maage-gradient-p-s", {
    ...lightThemeBase,
    color: [
      "#57856f",
      "#6ea089",
  ...
  echarts.registerTheme("maage-gradient-p-s-dark", {
    ...darkThemeBase,
    color: [
      "#b4d0c3",
      "#98bdac",
  ...
  echarts.registerTheme("maage-gradient-p-t", {
    ...lightThemeBase,
    color: [
      "#57856f",
      "#6ea089",
  ...
  echarts.registerTheme("maage-gradient-p-t-dark", {
    ...darkThemeBase,
    color: [
      "#b4d0c3",
      "#98bdac",
  ...
  echarts.registerTheme("maage-gradient-s-t", {
    ...lightThemeBase,
    color: [
      "#5f94ab",
      "#87afc0",
  ...
  echarts.registerTheme("maage-gradient-s-t-dark", {
    ...darkThemeBase,
    color: [
      "#c1d8e1",
      "#a0c1cf",
  ...
  echarts.registerTheme("maage-gradient-t-qn", {
    ...lightThemeBase,
    color: [
      "#dab46c",
      "#e7c788",
  ...
  echarts.registerTheme("maage-gradient-t-qn-dark", {
    ...darkThemeBase,
    color: [
      "#f4e4c2",
      "#edd5a6",
  ...
  echarts.registerTheme("maage-gradient-s-qn", {
    ...lightThemeBase,
    color: [
      "#5f94ab",
      "#87afc0",
  ...
  echarts.registerTheme("maage-gradient-s-qn-dark", {
    ...darkThemeBase,
    color: [
      "#c1d8e1",
      "#a0c1cf",
  ...
  echarts.registerTheme("maage-gradient-p-t-qn", {
    ...lightThemeBase,
    color: [
      "#6ea089",
      "#98bdac",
  ...
  echarts.registerTheme("maage-gradient-p-t-qn-dark", {
    ...darkThemeBase,
    color: [
      "#b4d0c3",
      "#98bdac",
